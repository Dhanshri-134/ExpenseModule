...
function buildCredentialsEmailHtml({ name, userCode, email, password, loginUrl }) {
...
export async function sendCredentialsEmail({ email, name, userCode, password, loginUrl }) {
  ...
  await transporter.sendMail({
    ...
    subject,
    text,
    html: buildCredentialsEmailHtml({ name, userCode, email, password, loginUrl }),
  });
